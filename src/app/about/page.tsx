...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "dev.Anmol@gmail",
    href: "mailto:dev.Anmol@gmail.com",
  ...
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/anmol001",
    content: "/anmol001",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/AnmolSharmaz",
    content: "/AnmolSharma",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Anmol Sharma</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Anmol, a Fullstack developer passionate about
